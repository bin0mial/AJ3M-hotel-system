...
@section('header')
    <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="/">{{ config('app.name', 'AJ3M') }}</a>
...
@section('content')
        ...
        <div class="row container">
            <div class="col-md-6 gx-5 mb-4">
                <div class="bg-image hover-overlay ripple shadow-2-strong" data-mdb-ripple-color="light">
                    ...
                    <a href="#!">
                        <div class="mask" style="background-color: rgba(251, 251, 251, 0.15); padding: 10px;"></div>
                    </a>
                </div>
            </div>
    ...
    <div class="justify-content-center d-flex mb-4">
        <h3>
            <a href="{{ route('clientHome.index') }}" class="text-decoration-none text-dark text-center">
                <h3>Check Our Rooms
                ...
                <div>
                    <img class=" w-25" src="{{ asset('images/hotel_images/hotel9.jpg') }}"
                         alt="Second slide">
                    <img class=" w-25" src="{{ asset('images/hotel_images/hotel10.jpg') }}"
                         alt="Third slide">
                </div>
            </a>
        </h3>
    ...
    <div style="text-align: center; margin-bottom: 20px;">
        <h3 class="mb-2">The luxury of being yourself!</h3>
    </div>
    <div class="container my-2">
        <!--Carousel Wrapper-->
        <div id="carousel-thumb" class="carousel slide carousel-fade carousel-thumbnails shadow-2-strong "
             data-ride="carousel">
            <!--Slides-->
        ...
        <section class="">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
                    ...
                    <p>
                        The AJ3M Porto hotel is a 4-star boutique hotel with many rooms located in the heart of terminal
                        land,
                        among agroup of listed buildings due to their historic value that date back to the late 18th
                        century.
                        The hotel sits next to the cosmopolitan terminal Square,
                        one of the city’s major leisure and shopping areas the terminal Railway Station and some of its
